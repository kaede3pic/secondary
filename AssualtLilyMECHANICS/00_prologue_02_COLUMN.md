...
そのため、彼女は実験に使われるリリィたちにとって、自身のできる得る限り負荷のかからない方法を提示するところまではできましたが、
最終的にその研究を止めることはできなかったのです。
...
その論争の結果、『リジェネレーター』のようにより良い研究成果を生み出すこともGEHENA側の思惑だったりもするのです。
